/********************************************************************************************************
 * @file    board_zg204zt.h
 *
 * @brief   This is the header file for HOBEIAN ZG-204ZT
 *          Human Motion + Luminance + T&H sensor (full variant)
 *
 *******************************************************************************************************/
#ifndef _BOARD_ZG204ZT_H_
#define _BOARD_ZG204ZT_H_

#include "version_cfg.h"

#if (BOARD == BOARD_ZG204ZT)
...
/* https://pvvx.github.io/ZG-204ZV/
 TLSR8253F512ET32 512K Flash
 GPIO_PA7 - SWS (keep as SWIRE for TLSRPGM access)
 GPIO_PB1 - TX
 GPIO_PC2 - LED (+Vbat)
 GPIO_PB5 - R lx
 GPIO_PB6 - R lx
...
#define ZCL_BASIC_MODEL_ID	   {10,'Z','G','-','2','0','4','Z','V','-','d'} // ZG-204ZV-d
...
// SWS - keep PA7 as SWire so TLSRPGM can re-flash without power cycling
...
// PIR / mmWave radar output
#define DEF_OCCUPANCY_DELAY		35	// sec
...
// XBR818 mmWave radar (I2C on PA0/PA1)
...
// Illuminance sensor (photo-resistor ADC)
...
#endif // (BOARD == BOARD_ZG204ZT)
#endif // _BOARD_ZG204ZT_H_
